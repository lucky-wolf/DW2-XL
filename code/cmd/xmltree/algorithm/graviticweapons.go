...
func (j *Job) applyGraviticWeapons() (err error) {
	...
	Small := ValuesTable{
		...
		"WeaponGraviticWeaponDamage":        IonComponentDamage,
	...
	MediumHeavyIonCannon := ExtendValuesTable(
		...
		ValuesTable{
			...
			"WeaponGraviticWeaponDamage": func(level int) float64 { return 1.25 * IonComponentDamage(level) },
	...
	LargeHeavyIonCannon := ExtendValuesTable(
		...
		ValuesTable{
			...
			"WeaponGraviticWeaponDamage": func(level int) float64 { return 1.5 * IonComponentDamage(level) },
	...
	MediumIonBomb := ValuesTable{
		...
		"WeaponGraviticWeaponDamage":        func(level int) float64 { return 1.33333 * IonComponentDamage(level) },
	...
	LargeIonBomb := ExtendValuesTable(
		...
		ValuesTable{
			...
			"WeaponGraviticWeaponDamage": func(level int) float64 { return 1.66666 * IonComponentDamage(level) },
